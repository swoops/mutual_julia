...
XPM_LIBS	= $(HACK_PRE)            -lXpm -pthread -lgdk_pixbuf_xlib-2.0 -lgmodule-2.0 -lrt -lgdk_pixbuf-2.0 -lgobject-2.0 -lglib-2.0   $(HACK_POST2)
GLE_LIBS	= $(HACK_PRE)  -lXpm -pthread -lgdk_pixbuf_xlib-2.0 -lgmodule-2.0 -lrt -lgdk_pixbuf-2.0 -lgobject-2.0 -lglib-2.0   $(HACK_POST2)
...
INCLUDES	= $(INCLUDES_1)  -pthread -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng12 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include  
...
julia_gl.o: $(UTILS_SRC)/visual.h
julia_gl.o: $(UTILS_SRC)/xshm.h
julia_gl.o: $(UTILS_SRC)/yarandom.h
julia_gl.o: $(HACK_SRC)/xlockmoreI.h
julia_gl.o: $(HACK_SRC)/xlockmore.h
dnalogo.o: ../../config.h
